...
var DateRangePicker = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _props$as = props.as,
      ...
      rest = _objectWithoutPropertiesLoose(props, ["as", "classPrefix", "className", "appearance", "cleanable", "character", "defaultCalendarValue", "defaultValue", "disabled", "disabledDate", "format", "hoverRange", "isoWeek", "limitEndYear", "locale", "menuClassName", "menuStyle", "oneTap", "placeholder", "placement", "ranges", "renderValue", "showOneCalendar", "showWeekNumbers", "style", "toggleAs", "value", "onChange", "onClean", "onClose", "onEnter", "onEntered", "onExited", "onOk", "onOpen", "onSelect", "renderCustomPicker"]);
  ...
  */
  ...
  var handleSingleInputChange = useCallback(function (event) {
    var _event$target;
  ...
  var renderDropdownMenu = function renderDropdownMenu(positionProps, speakerRef) {
    ...
    return /*#__PURE__*/React.createElement(PickerOverlay, {
      ...
      ,
      mask: DateUtils.getDateMask(formatStr) // value={value ? (getDisplayString(value, true) as string) : ''}
      ,
      ...
      index: 0
    }, panelProps)), /*#__PURE__*/React.createElement(Calendar, _extends({
      index: 0
    }, panelProps, {
      calendarDate: [previewCalendarDate, calendarDate[1]],
      previewOnly: true,
      className: "second-calendar"
    })), !showOneCalendar && /*#__PURE__*/React.createElement(Calendar, _extends({
      index: 1
    }, panelProps)))), !oneTap && /*#__PURE__*/React.createElement(Toolbar, {
      locale: locale,
  ...
  return /*#__PURE__*/React.createElement(PickerToggleTrigger, {
    ...
    style: style
  }, renderCustomPicker ? renderCustomPicker(value, formatStr) : /*#__PURE__*/React.createElement(PickerToggle, _extends({}, omit(rest, [].concat(omitTriggerPropKeys, usedClassNamePropKeys, DateUtils.calendarOnlyProps)), {
    as: toggleAs,
    ref: targetRef,
    appearance: appearance,
    input: true,
