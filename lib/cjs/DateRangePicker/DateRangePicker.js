...
var DateRangePicker = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  var _props$as = props.as,
      ...
      formatStr = _props$format === void 0 ? 'dd/MM/yyyy' : _props$format,
      ...
      renderCustomPicker = props.renderCustomPicker,
      rest = (0, _objectWithoutPropertiesLoose2.default)(props, ["as", "classPrefix", "className", "appearance", "cleanable", "character", "defaultCalendarValue", "defaultValue", "disabled", "disabledDate", "format", "hoverRange", "isoWeek", "limitEndYear", "locale", "menuClassName", "menuStyle", "oneTap", "placeholder", "placement", "ranges", "renderValue", "showOneCalendar", "showWeekNumbers", "style", "toggleAs", "value", "onChange", "onClean", "onClose", "onEnter", "onEntered", "onExited", "onOk", "onOpen", "onSelect", "renderCustomPicker"]);
  ...
  */
  ...
  var handleSingleInputChange = (0, _react.useCallback)(function (event) {
    var _event$target;

    setInputState('Typing');
    var value = (_event$target = event.target) === null || _event$target === void 0 ? void 0 : _event$target.value;
    var rangeValue = [value, value]; // isMatch('01/11/2020', 'MM/dd/yyyy') ==> true
  ...
  var renderDropdownMenu = function renderDropdownMenu(positionProps, speakerRef) {
    ...
    var clonedCalendarDate = new Date(calendarDate[0]);
    var previewCalendarDate = new Date(clonedCalendarDate === null || clonedCalendarDate === void 0 ? void 0 : clonedCalendarDate.setMonth(clonedCalendarDate.getMonth() + 1));
    var panelProps = {
    ...
    return /*#__PURE__*/_react.default.createElement(_Picker.PickerOverlay, {
      ...
      onBlur: handleInputPressEnd // onFocus={onInputFocus}
      ,
      onChange: handleSingleInputChange,
      onKeyDown: onPickerKeyDown // id={id}
      // aria-hidden={!inputFocused}
      // readOnly={!inputFocused}
      ,
      disabled: disabled // aria-controls={id ? `${id}-listbox` : undefined}
      ,
      tabIndex: -1,
      className: prefix('textbox') // render={(ref, props) => <input ref={mergeRefs(inputRef, ref)} {...props} />}
      ,
      mask: _utils.DateUtils.getDateMask(formatStr) // value={value ? (getDisplayString(value, true) as string) : ''}
      ,
      ...
      index: 0
    }, panelProps)), /*#__PURE__*/_react.default.createElement(_Calendar2.default, (0, _extends2.default)({
      index: 0
    }, panelProps, {
      ...
      index: 1
    }, panelProps)))), !oneTap && /*#__PURE__*/_react.default.createElement(_Toolbar.default, {
      locale: locale,
  ...
  return /*#__PURE__*/_react.default.createElement(_Picker.PickerToggleTrigger, {
    ...
    style: style
  }, renderCustomPicker ? renderCustomPicker(value, formatStr) : /*#__PURE__*/_react.default.createElement(_Picker.PickerToggle, (0, _extends2.default)({}, (0, _omit.default)(rest, [].concat(_Picker.omitTriggerPropKeys, usedClassNamePropKeys, _utils.DateUtils.calendarOnlyProps)), {
    as: toggleAs,
    ref: targetRef,
    appearance: appearance,
    input: true,
